...
Why an org file? My Emacs config is large, and this enables me to greatly improve readability of its documentation. I edit this file the same way you're reading it (nicely formatted) as I use Emacs and Emacs speaks org. Sounds complicated, but it's really not; [[https://github.com/usrbinkat/nixos-config/blob/main/nixos/default.nix#L215][just a few lines]] in my Nix config. [[https://github.com/usrbinkat/nixos-config/blob/main/darwin/default.nix#L28][MacOS too.]]

This is the main configuration, but there also exists one more init file, ~init.el~ , that bootstraps ~org-mode~ before this file is interpreted. That's defined [[https://github.com/usrbinkat/nixos-config/blob/main/shared/files.nix#L5][here]].
...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Kat Morgan"
    user-mail-address "usrbinkat@braincraft.io")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/usrbinkat/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/usrbinkat/bin" "/profile/bin" "/Users/usrbinkat/.npm-packages/bin" "/Users/usrbinkat/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setq org-capture-templates
      `(("t" "Todo" entry (file+headline ,"~/.local/share/org-roam/20220419121404-todo.org" "Tasks")
         "* TODO %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("p" "Project" entry (file+headline ,"~/.local/share/org-roam/20220419121404-todo.org" "Projects")
         "* PROJECT %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("h" "Health" entry (file+headline ,"~/.local/share/org-roam/20230712154159-health.org" "Tasks")
         "* TODO %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("H" "Health Project" entry (file+headline ,"~/.local/share/org-roam/20230712154159-health.org" "Projects")
         "* PROJECT %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("f" "Family/Social" entry (file+headline ,"~/.local/share/org-roam/20230712154441-family_social.org" "Tasks")
         "* TODO %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("F" "Family/Social Project" entry (file+headline ,"~/.local/share/org-roam/20230712154441-family_social.org" "Projects")
         "* PROJECT %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("b" "Business" entry (file+headline ,"~/.local/share/org-roam/20230712154303-business.org" "Tasks")
         "* TODO %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("B" "Business Project" entry (file+headline ,"~/.local/share/org-roam/20230712154303-business.org" "Projects")
         "* PROJECT %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("l" "Home Lab" entry (file+headline ,"~/.local/share/org-roam/20210919225144-home_lab.org" "Tasks")
         "* TODO %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("L" "Home Lab Project" entry (file+headline ,"~/.local/share/org-roam/20210919225144-home_lab.org" "Projects")
         "* PROJECT %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("v" "Braeview" entry (file+headline ,"~/.local/share/org-roam/20210814100042-braeview.org" "Tasks")
         "* TODO %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a\n:END:\n\n%i")
        ("V" "Braeview Project" entry (file+headline ,"~/.local/share/org-roam/20210814100042-braeview.org" "Projects")
         "* PROJECT %?\n:PROPERTIES:\n:ID:       %(org-id-uuid)\n:CREATED:  %U\n:SOURCE:  %a]\n:END:\n\n%i")))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun dl/load-buffer-with-emacs-config ()
    ...
    (interactive)
    (dl/find-file "~/.local/share/src/nixos-config/shared/config/emacs/config.org"))

  (defun dl/load-buffer-with-todo ()
    "Open the emacs configuration"
    (interactive)
    (dl/find-file "~/.local/share/org-roam/20220419121404-todo.org"))

  (defun dl/load-buffer-with-nix-config ()
    "Open the emacs configuration"
    (interactive)
    (dl/find-file "~/.local/share/src/nixos-config/shared/home-manager.nix"))

  (defun dl/load-buffer-with-good-data-lol ()
    "Open the emacs configuration"
    (interactive)
    (dl/find-file "~/.local/share/src/good-data-lol/apps/orchestrator/src/index.ts"))
  ...
  (dl/leader-keys
    ...
    "g"  '(dl/load-buffer-with-good-data-lol :which-key "open good data")
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-roam
    :straight (:host github :repo "usrbinkat/org-roam"
               :branch "master"
  ...
  '(("d" "default" entry
     ...
     :if-new (file+head "%<%Y-%m-%d>.org"
                        (lambda () (concat ":PROPERTIES:\n:ID:       " (org-id-new) "\n:END:\n"
                                           "#+TITLE: %<%Y-%m-%d>\n#+filetags: Daily \n" ; Added space here
                                           "[[id:F355F26D-E4E5-4CF5-99EA-E77846D47FAF][Workflow]]\n\n"
                                           "* Log\n"))))))
#+END_SRC
